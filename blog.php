    ...
    <div id="content-wrap" class="content__wrapper">
        <div class="container">
            <div id="sidebar" class="py-5">
                <form class="d-flex search__form" action="search.php" method="GET">
                    <input type="text" name="search" class="form-control box__search" placeholder="Nhập từ khóa tìm kiếm..." onkeyup="livesearch(this.value)">
