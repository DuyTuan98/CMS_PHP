                                  ...
                                  while ($row_posts = mysqli_fetch_array($run_posts))
                                  {
                                    ...
                                    <article class="hentry">
                                        <div class="post-media clearfix">
                                            <a href="#"><img src="img/<?php echo $post_image ?>" alt="Image"></a>
                                        </div><!-- .post-media -->
                                        ...
                                        <div class="post-content-wrap">
                                            ...
                                            <div class="post-content post-excerpt">
                                                ...
                                                <h4 class="bg__white ml-5"></h4>
                                                <p class="ml-5"><img src="img/<?php echo $image_explain ?>" alt=""></p>
                        ...
                        <div id="inner-sidebar" class="inner-content-wrap">
                            <div class="widget widget_search">
                                <div class="widget-content-wrap">
                                    <form role="search" action="search.php" method="GET" class="search-form style-1">
                                        <input type="text" class="search-field" placeholder="Nhập từ khóa tìm kiếm..." name="search" title="Search for:" onkeyup="livesearch(this.value)">
                                        <button type="submit" class="search-submit" title="Search">Tìm kiếm</button>
                                    </form>
                                    <div id='result' class="result_v"></div>
                                </div>
                            </div><!-- .widget_search -->
